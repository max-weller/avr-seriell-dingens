...
#define SOFTUART_BAUD_RATE      2400
...
#if defined (__AVR_ATmega3216__) || defined (__AVR_ATmega3216P__) || defined (__AVR_ATmega3216PU__) || defined(__AVR_ATmega32__)

    #define SOFTUART_RXPIN   PIND
    #define SOFTUART_RXDDR   DDRD
    #define SOFTUART_RXBIT   PD5
    ...
    #define SOFTUART_CTC_MASKB         (1 << WGM01)
